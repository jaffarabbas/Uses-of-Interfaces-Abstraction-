...
interface Speacial_Alounces_To_Top_Emploies {
...
//Class that implemts Interface 1,2,3 and this is best example of Multi inheritance
//class implements different interfaces so they can combinly run program
// *************CLASS*************
class Department_Database_Backend implements Speacial_Alounces_To_Top_Emploies,Yearly_Employ_Career_Report,Employ_info{//this is a class that implments Multiple Interface 
