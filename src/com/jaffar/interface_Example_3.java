...
//Interface extends more then one Interface

//In this code  one interface is extended by more then one interface
...
interface Speacial_Alounces_To_Top_Emploies extends Yearly_Employ_Career_Report,Employ_info{
    ...
    String ToString();//this is method to print all instants and also for the extended interfaces
    void Clearence_From_Authoritreze();//Security check my nested satement to grant permission
    void Certificate_of_alunce();
}


class Department_Database_Backend implements Speacial_Alounces_To_Top_Emploies{//this is a class that implments Interface that extend another interface
    ...
    /********************************************************************************************/
    //Method Of Of interface 3
    //it is a method that uses nested if to give certifiction to us
...
public class interface_Example_3 {
    public static void main(String[] args) {
        ...
        System.out.println("This is Example NO 3\n\nInterface extends more then one Interface\n\nIn this code  one interface is extended by more then one interface");   
